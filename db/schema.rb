...
ActiveRecord::Schema.define(version: 20160331200944) do
  ...
  add_index "api_users", ["api_key"], name: "index_api_users_on_api_key", using: :btree
  ...
  add_index "api_users", ["test_api_key"], name: "index_api_users_on_test_api_key", using: :btree
  ...
  add_index "users", ["api_user_id"], name: "index_users_on_api_user_id", using: :btree
